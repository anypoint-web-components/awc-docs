...
export class PageCheckbox extends DemoPage {
  ...
  constructor() {
    super();
    this.initObservableProperties(['demoDisabled']);
  ...
  _demoTemplate() {
    const { demoStates, darkThemeActive, demoDisabled } = this;
    return html`
      <section class="this.shadowRootation-section">
        <h3>Interactive demo</h3>
        <p>
          This demo lets you preview the radio button in a radio group with various configuration
          options.
        </p>
        <arc-interactive-demo .states="${demoStates}" ?dark="${darkThemeActive}">
          <anypoint-checkbox slot="content" ?disabled="${demoDisabled}">
            Label
          </anypoint-checkbox>
  ...
  _usageTemplate() {
    return html`
      <section class="documentation-section">
        ...
        <p>
          Checkbox allows to select one or more option from a set of options. If the user is
          expected to toggle a view, a switch should be used instead.
        </p>
        ...
        <p>
          ...
          <a href="https://material.io/design/components/selection-controls.html#checkboxes"
            >Checkboxes</a
          >
          documentation in Material Design documentation for principles and anatomy of a checkbox.
        </p>
    ...
    ${`<html>
      ...
      <body>
        ...
        <p>A chekcbox can be <b>unselected</b>, <b>selected</b>, or <b>indeterminate</b>.</p>

        <h4>Indeterminate state</h4>
        <p>
          The indeterminate state is when a parent checkbox on complex selection group has child
          checkboxes that are both selected and unselected.
        </p>
        ...
        <div class="centered">
          <anypoint-checkbox
            indeterminate
            id="communication"
            @change="${this._communicationHandler}"
            >Communication</anypoint-checkbox
          >
          <div class="communication-options">
            <anypoint-checkbox name="email" checked @change="${this._communicationItemHandler}"
              >Email</anypoint-checkbox
            >
            <anypoint-checkbox name="sms" @change="${this._communicationItemHandler}"
              >SMS</anypoint-checkbox
            >
            <anypoint-checkbox name="push" @change="${this._communicationItemHandler}"
              >Push notification</anypoint-checkbox
            >
            <anypoint-checkbox name="mail" @change="${this._communicationItemHandler}"
              >Mail</anypoint-checkbox
            >
          </div>
        </div>
  ...
  _ironFormTemplate() {
    return html`
      <section class="documentation-section">
        ...
        <p>
          Currently the spec allowing custom elements to be accepted by the &lt;form&gt; element is
          work in progress. We suggest using
        ...
        <div class="centered">
          <iron-form id="form">
            <form>
              <fieldset>
                <anypoint-checkbox name="subscribe" value="newsletetr"
                  >Subsceribe to our newsletter</anypoint-checkbox
                >
                <anypoint-checkbox name="tems" value="accepted" checked required
                  >Agree to terms and conditions</anypoint-checkbox
                >
                <anypoint-checkbox name="disabled" value="noop" disabled
                  >This is never included</anypoint-checkbox
                >
              </fieldset>
            </form>
          </iron-form>
  ...
  _formTemplate() {
    return html`
      <section class="documentation-section">
        ...
        <p>
          Form-associated custom elements enable web authors to define and create custom elements
          which participate in form submission. Learn more:
          <a href="https://www.chromestatus.com/feature/4708990554472448" target="_blank"
            >Chrome status</a
          >
        </p>
        ...
        ${hasFormAssociatedElements
          ? html`
              <p>Your browser support this API</p>
            `
          : html`
              <p>Your browser <b>does not</b> support this API</p>
            `}

        <div class="centered">
          <form id="nativeForm" @submit="${this._nativeSubmit}">
            <fieldset>
              <anypoint-checkbox name="options" value="newsletetr" required
                >Subsceribe to our newsletter</anypoint-checkbox
              >
              <anypoint-checkbox name="options" value="accepted" checked required
                >Agree to terms and conditions</anypoint-checkbox
              >
              <anypoint-checkbox name="options" value="optional"
                >This is optional</anypoint-checkbox
              >
              <anypoint-checkbox name="options" value="noop" disabled
                >This is never included</anypoint-checkbox
              >
            </fieldset>
  ...
  _workingWithFormsTemplate() {
    return html`
      <section class="documentation-section">
        ...
        ${this._ironFormTemplate()} ${this._formTemplate()}
      </section>
    `;
  }

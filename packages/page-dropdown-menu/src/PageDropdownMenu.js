...
export class PageDropdownMenu extends DemoPage {
  ...
  _mainDemoStateHandler(e) {
    ...
    this.notifyStateChange(gaValue);
  }
    ...
    return html`
      <section class="documentation-section">
        ...
        >
          ...
          >
            <anypoint-radio-button @change="${this._mainDemoAssistiveHandler}" checked name="none"
              >None</anypoint-radio-button
            >
            <anypoint-radio-button @change="${this._mainDemoAssistiveHandler}" name="info"
              >Info message</anypoint-radio-button
            >
            <anypoint-radio-button @change="${this._mainDemoAssistiveHandler}" name="error"
    ...
    return html`
      <section class="documentation-section">
        ...
        <p>
          ...
          >
          documentation in Material Defign documentation for principles and anatomy of dropdown
          menus.
        </p>
...
window.customElements.define('simple-element', SimpleElement);`}
        ...
        <p>
          The <code>anypoint-listbox</code> component also allows to select an item by it's
          attribute by setting <code>attrforselected</code> attribute.
        </p>
        <anypoint-dropdown-menu>
  ...
  _formsTemplate() {
    ...
    return html`
      <section class="documentation-section">
        ...
        <p>
          Anypoint dropdown menu support basic form states like <code>disabled</code> or
          <code>invalid</code>.
        </p>
        ...
        <p>
          Anypoint web components offers <code>ValidatorMixin</code> that allows to define a custom
          element that validates an input field. This allows to reuse validation logic accross
        ...
        ${hasFormAssociatedElements
          ...
          : html`
            ...
            `}
        <arc-interactive-demo states='["Native form"]' ?dark="${darkThemeActive}">
  ...
  _assistiveTemplate() {
    return html`
      <section class="documentation-section">
        ...
        <p>
          Assistive text allows the user to better understand what kind of selection is required. It
          can be an info message or invalid message when invalid input has been detected.
        </p>

        <h3>Info message</h3>
        <p>
          Info message provides the user with additional description for the field. It should be
          used when the label can be confusing or to ensure the user about the reason of collecting
          the input.
        </p>
        ...
        <p>
          Do not try to put too detailed information. The user should be able to scan the message in
          a fraction of a second. Treat it as an additional text for the label.
        </p>

        <h3>Invalid message</h3>
        <p>
          Error message should help the user recover from the error state. Use clear message with
          simple instructions of how to fix the problem, for example
          <code>Selection is required</code>.
        </p>
  ...
  contentTemplate() {
    return html`
      ...
      ${this._formsTemplate()} ${this._assistiveTemplate()}
    `;
  }
}

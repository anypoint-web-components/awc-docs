...
export default html`
  <section class="documentation-section">
    ...
    <p>
      ...
      documentation in Material Defign documentation for principles and anatomy of dropdown menus.
    </p>
...
window.customElements.define('simple-element', SimpleElement);`}
    ...
    <p>
      Use filled button for the primary action. There should not be more than 1 primary action per
      screen. If you need more primary actions than probably you actually need outlined button or
      change in the information architecture.
    </p>
    ...
    <p>
      Usually not required but placing a leading icon can clarify the action and focus attention on
      the button.
    </p>
